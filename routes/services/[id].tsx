...
export default function Details(
  ...
  return (
    <div class="p-4 mx-auto max-w-screen-md font-mono font-mono">
      ...
      {service.other_music ? (
        <div class="rounded-md bg-[#f9f9f9] border border-[#c9d48a] p-4 mt-8">
          <h2 class="text-xl">{service.other_music}</h2>
          {service.other_pdf ? (
            <a
              class={tw`rounded-full inline-block my-6 px-6 py-3 bg-[#c9d48a]`}
              href={`https://npcovenant-cc.s3.us-east-2.amazonaws.com/${service.other_pdf}.pdf`}
              target="_blank"
            >
              SHEET MUSIC
            </a>
      ...
      <a class="block my-12 text-2xl" href="/">
        ← Back
      </a>
    </div>
  )
